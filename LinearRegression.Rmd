...
author: "Joshua Hunt, summarized by Hayden Grimes"
date: "`r Sys.Date()`"
output: distill::distill_article
---
###  At its most basic level, linear regression is a method of estimating the connection between two variables. It presupposes that the two variables have a direct link and that this relationship may be represented by a straight line. ###

### We will use a data set called, tips. This data set includes variables such as tip amount, bill amount, and information about the person giving the tip.###

### Linear regression can be useful in accounting. It can help you find certain trends that can predict future costs or outcomes in the future.###
